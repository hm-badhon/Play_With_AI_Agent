...
# Initialize Agents
ophthalmology_agent = Agent(model=Gemini(id="gemini-2.0-flash-exp"), tools=[DuckDuckGoTools()], markdown=True, name="Eye Doctor")
cardiology_agent = Agent(model=Gemini(id="gemini-2.0-flash-exp"), tools=[DuckDuckGoTools()], markdown=True, name="Cardiology Doctor")
orthopedics_agent = Agent(model=Gemini(id="gemini-2.0-flash-exp"), tools=[DuckDuckGoTools()], markdown=True, name="Orthopedics Specialist")
medicine_last_opinion_agent = Agent(model=Gemini(id="gemini-2.0-flash-exp"), tools=[DuckDuckGoTools()], markdown=True, name="Medicine Doctor (Last Opinion)")
